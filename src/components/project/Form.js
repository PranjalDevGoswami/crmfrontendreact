...
// import select from '../MultipleValueDropDown'
  ...
  return (
    <div className="relative">
      ...
      >
              ...
              <Dropdown
                name={"Project_Type"}
                className={"p-2 outline-none cursor-pointer w-[100%] bg-transparent border"}
              ...
              />
                ...
                <Dropdown
                  name={"Client"}
                  className={"p-2 outline-none cursor-pointer w-[100%] relative bg-transparent border"}
             ...
             <Label labelName={"Setup Fee "} className={""} />
              <Input
                ...
                required
              />
              <Button className={'bg-green-300 p-2 absolute right-0 top-[5.1rem] translate-y-[-0%] text-sm'} name={'Add Other Fee'} onClick={OpenOtherFee}/>
             </div>
              {
                isOtherFee?<div className="w-1/2 h-1/3 bg-white border rounded-md shadow-md z-50 absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%"><div className="bg-white w-full h-full flex items-center justify-center relative"><Label labelName={"Other Cost"} className={"p-2"} />
                
                <MultipleValueDropDown onChange={MultipleValueSection} className={'w-full'}/>
              <Button name={'X'} className={'bg-red-400 p-2 w-8 h-8 rounded-full absolute top-4 right-8 flex items-center justify-center text-white'} onClick={CloseOtherFeehandler}/>
                </div></div>:''
              }
              ...
              />
                ...
                <Input
                  ...
                  required
                />
                <CheckboxList InputItems={['Advanced Payment Required']} onCheckboxChange={handleCheckboxChange}/>
                <Label labelName={'SOW File'} className={'pt-4'}/> 
                <MultipleFileUpload />
                <div className="flex justify-around">
                 <Link to={'/sales-dashboard'} className="inline-block w-1/2 mr-2"> 
                 <Button className="bg-green-500 p-4 mt-8 w-full " name={"Submit"} />
                 </Link>
