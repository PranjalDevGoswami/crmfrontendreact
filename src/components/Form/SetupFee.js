      ...
      <div className="flex w-full items-center">
        <div className="w-full inline-block">
          <Input
            ...
            className={"p-2 border bg-[#f3eded] w-full rounded-r-none mt-2 rounded-md"}
            // min={0}
          />
        </div>
        <div className="w-[7%] bg-yellow-200 flex items-center justify-center rounded-md rounded-l-none mt-2">
